***********************************************************************
*	OrganicFelineMockSetupRegistry.prg
*	
*	Registro de setups y teardowns de mocks específicos para Organic.Feline.
...
*	    goMockSetupRegistry = NEWOBJECT("OrganicFelineMockSetupRegistry", "OrganicFelineMockSetupRegistry.prg")
*	
...
Define Class OrganicFelineMockSetupRegistry As MockSetupRegistry Of MockSetupRegistry.prg
