***********************************************************************
*	OrganicGeneratorMockSetupRegistry.prg
*	
*	Registro de setups y teardowns de mocks específicos para Organic.Generator.
...
*	    goMockSetupRegistry = NEWOBJECT("OrganicGeneratorMockSetupRegistry", "OrganicGeneratorMockSetupRegistry.prg")
*	
...
Define Class OrganicGeneratorMockSetupRegistry As MockSetupRegistry Of MockSetupRegistry.prg
