<#
.SYNOPSIS
    Genera archivo build.h con constantes de compilaciÃ³n para Organic
.DESCRIPTION
    Script de prebuild que genera build.h con constantes de versiÃ³n.
...
.PARAMETER BuildDebug
    Modo de compilaciÃ³n (1=Debug, 2=Release)
.PARAMETER Major
    NÃºmero de versiÃ³n Major (viene de dovfp build)
.PARAMETER Minor
    NÃºmero de versiÃ³n Minor/Release (viene de dovfp build)
.PARAMETER Build
    NÃºmero de build (viene de dovfp build)
.PARAMETER ExeName
    Nombre del ejecutable sin extensiÃ³n
...
.PARAMETER KeyVaultName
    Nombre del Azure Key Vault donde estÃ¡n el endpoint y apikey.
.EXAMPLE
    .\Generate-BuildH.ps1 -BuildDebug 1 -Major 1 -Minor 0 -Build 12345 -ExeName "Organic.Dragonfish"
.EXAMPLE
    .\Generate-BuildH.ps1 -BuildDebug 2 -Major 1 -Minor 0 -Build 12345 -ExeName "Organic.Dragonfish" -KeyVaultName "mykeyvault"
#>
...
Write-Host ""
Write-Host "======================================================="
Write-Host "  DOVFP - Generador build.h (Organic.Dragonfish)"
Write-Host "======================================================="
Write-Host ""

try
{
    Write-Host "  Ruta de destino: $BuildHPath"
    ...
    $anio = $fecha.Year
    Write-Host "  Mes: $mes"
    Write-Host "  Anio: $anio"

    # Determinar nombre del EXE
    Write-Host "  Configurando nombre del ejecutable..."
    $nombreExe = $ExeName
    if ($SimularRefoxeo)
    {
