...
/****** Object:  UserDefinedFunction [Objetivos].[AusenciasJustificadas]    Script Date: 07/05/2013 17:13:07 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Devuelve la Ausencias Justificadas
-- =====================================================
ALTER FUNCTION [Objetivos].[AusenciasJustificadas]
(	
	@Legajo VARCHAR(4),
