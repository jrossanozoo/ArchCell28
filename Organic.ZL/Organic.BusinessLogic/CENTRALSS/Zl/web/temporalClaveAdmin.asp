                      ...
                      <table width="648" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td class="texto_titulos">
                            <font color="#006600">Desativaci&oacute;n temporal de Seguridad</font>
                          </td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
...
-->
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" style="padding-left: 3px;" height="50" width="100%">
                                          <input type="button" name="boton" id="boton" value="Enviar" onclick="validarSerieVersionOrganic(2);" >
                                        </td>
                                      </tr>
                                      <tr>
