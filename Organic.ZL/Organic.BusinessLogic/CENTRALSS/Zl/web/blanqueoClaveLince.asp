                      ...
                      <table width="648" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td class="texto_titulos">
                            <font color="#006600">Restauraci&oacute;n de Clave Lince Indumentaria</font></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
                            ...
                            <table cellSpacing="1" cellPadding="1" width="100%" border="0">
                              ...
                              <tr>
                                <td width="100%" valign="top" align="left">
                                  <form method="post" name="formSerie" id="formSerie" >
                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                      <tr>
                                        <td width="20%" align="right" class="texto_contenido_01" style="padding-right: 3px; border: 1px none;border-radius: 4px; height: 30px;">
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" style="padding-left: 3px;" height="50" width="100%">
                                          <input type="button" name="boton" id="boton" value="Enviar" onClick="validarSerieLince();" >
                                        </td>
                                      </tr>
                                      <tr>
